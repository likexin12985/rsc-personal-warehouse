#!/usr/bin/env python3
"""Build-independent local opening-fixture checks in a new owned native PG16 cluster.
...
def main(argv=None):
    ...
    report=None
    try:
        with native_cluster(postgres_bin=args.postgres_bin,artifact_root=CLOUD/'artifacts/opening-release-fixtures-20260920/checks') as (directory,engines):
            report=directory
            ...
            from pg16_opening_fixture_gate import run
            result=run(engines)
