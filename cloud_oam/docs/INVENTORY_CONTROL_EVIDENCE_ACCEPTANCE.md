...
> 2026-09-20 / 7.53：新增物料 HMAC 接收、准确传输登记与回执恢复，仍不创建正式物料或控制库存。
> 来源业务授权、正式投影和真库门禁继续保留，见[物料接收与证据](MATERIAL_CAPTURE_INGRESS_20260920.md)。

> 2026-09-20 / 7.52：已有两轮 OAM 备件主数据采集与可重验私有观察文件；尚未接认证接收和正式投影。
> 正式映射批准/撤销保留。观察文件不能替代主数据来源证明，见[物料采集](MATERIAL_MASTER_CAPTURE_20260920.md)。
> 见[正式映射版本](INVENTORY_CONTROL_MAPPINGS_20260920.md)，真实 PG16/发布/启动门禁保持。
> 见[数量正规化审核](INVENTORY_CONTROL_NORMALIZATION_20260920.md)，真实 PG16/发布/启动门禁保持。
> 原离线结果保持；密钥生命周期和实际受控发布仍待完成。见[最新授权核验](INVENTORY_CONTROL_ADMISSION_20260920.md)。

> 2026-09-20 / 7.48：新增 0114 隔离 HMAC 声明接收、不可变凭据及逐段准备链观察，本地联合
> 902 项通过。原离线一致性与准备结果不变，配置渠道认证不代表授权或发布。见
> [最新凭据验证与后续边界](INVENTORY_CONTROL_ATTESTATION_20260920.md)。
