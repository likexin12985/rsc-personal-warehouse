...
当前开发源码的唯一 Alembic head 为 `20260905_0060`；本次供给计划变更尚待准确 SHA 的
PostgreSQL 16 门禁，以上 `0058` 成功记录仅为历史验收基线，不覆盖新增源码。
...
拒绝，并对已有图进行因果预检。有供给事实时禁止降级；完整清单见
[0059–0060 供给计划发布清单](docs/SUPPLY_TASK_0059_RELEASE_RUNBOOK.md)。
