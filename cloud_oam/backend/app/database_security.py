...
EXPECTED_MATERIAL_REQUEST_APPROVAL_TRIGGERS = {
    ...
    'trg_stock_operation_return_inbound_lines_proof_0106': ('stock_operation_return_inbound_lines', 'rsc_dispatch_stock_return_inbound_0106', 'A', 5, True, True, True),
    'trg_stock_operation_return_inbound_lines_immutable_0106': ('stock_operation_return_inbound_lines', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_return_inbound_lines_no_truncate_0106': ('stock_operation_return_inbound_lines', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_return_inbound_serials_proof_0106': ('stock_operation_return_inbound_serials', 'rsc_dispatch_stock_return_inbound_0106', 'A', 5, True, True, True),
    'trg_stock_operation_return_inbound_serials_immutable_0106': ('stock_operation_return_inbound_serials', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_return_inbound_serials_no_truncate_0106': ('stock_operation_return_inbound_serials', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_return_inbound_postings_proof_0106': ('stock_operation_return_inbound_postings', 'rsc_dispatch_stock_return_inbound_0106', 'A', 5, True, True, True),
    'trg_stock_operation_return_inbound_postings_immutable_0106': ('stock_operation_return_inbound_postings', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_return_inbound_postings_no_truncate_0106': ('stock_operation_return_inbound_postings', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    ...
    'trg_stock_operation_shipment_lines_proof_0104': ('stock_operation_shipment_lines', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_stock_operation_shipment_lines_immutable_0104': ('stock_operation_shipment_lines', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_shipment_lines_no_truncate_0104': ('stock_operation_shipment_lines', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_shipment_serials_proof_0104': ('stock_operation_shipment_serials', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_stock_operation_shipment_serials_immutable_0104': ('stock_operation_shipment_serials', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_shipment_serials_no_truncate_0104': ('stock_operation_shipment_serials', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_shipments_return_shipment_0104': ('shipments', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_shipment_lines_return_shipment_0104': ('shipment_lines', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_logistics_events_return_shipment_0104': ('logistics_events', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_receipts_return_shipment_0104': ('receipts', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_inventory_transactions_return_shipment_0104': ('inventory_transactions', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_audit_events_return_shipment_0104': ('audit_events', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_outbox_events_return_shipment_0104': ('outbox_events', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_state_transition_events_return_shipment_0104': ('state_transition_events', 'rsc_dispatch_stock_return_shipment_0104', 'A', 5, True, True, True),
    'trg_stock_operation_shipments_seal_0104': ('stock_operation_shipments', 'rsc_guard_stock_operation_seal_0101', 'A', 5, True, True, True),

    'trg_stock_operation_outbounds_proof_0103': ('stock_operation_outbounds', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_stock_operation_outbounds_immutable_0103': ('stock_operation_outbounds', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_outbounds_no_truncate_0103': ('stock_operation_outbounds', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_outbound_lines_proof_0103': ('stock_operation_outbound_lines', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_stock_operation_outbound_lines_immutable_0103': ('stock_operation_outbound_lines', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_outbound_lines_no_truncate_0103': ('stock_operation_outbound_lines', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_outbound_serials_proof_0103': ('stock_operation_outbound_serials', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_stock_operation_outbound_serials_immutable_0103': ('stock_operation_outbound_serials', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_outbound_serials_no_truncate_0103': ('stock_operation_outbound_serials', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_inventory_transactions_return_outbound_0103': ('inventory_transactions', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_inventory_movements_return_outbound_0103': ('inventory_movements', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_inventory_movement_serials_return_outbound_0103': ('inventory_movement_serials', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_audit_events_return_outbound_0103': ('audit_events', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_outbox_events_return_outbound_0103': ('outbox_events', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_state_transition_events_return_outbound_0103': ('state_transition_events', 'rsc_dispatch_stock_return_outbound_0103', 'A', 5, True, True, True),
    'trg_stock_operation_outbounds_seal_0103': ('stock_operation_outbounds', 'rsc_guard_stock_operation_seal_0101', 'A', 5, True, True, True),
    ...
    'trg_stock_operation_lines_proof_0100': ('stock_operation_lines', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_stock_operation_lines_immutable_0100': ('stock_operation_lines', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_lines_no_truncate_0100': ('stock_operation_lines', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_serials_proof_0100': ('stock_operation_serials', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_stock_operation_serials_immutable_0100': ('stock_operation_serials', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_serials_no_truncate_0100': ('stock_operation_serials', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_stock_operation_cancellations_proof_0100': ('stock_operation_cancellations', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_stock_operation_cancellations_immutable_0100': ('stock_operation_cancellations', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_stock_operation_cancellations_no_truncate_0100': ('stock_operation_cancellations', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_inventory_transactions_return_0100': ('inventory_transactions', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_inventory_movements_return_0100': ('inventory_movements', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_inventory_movement_serials_return_0100': ('inventory_movement_serials', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_audit_events_return_0100': ('audit_events', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_outbox_events_return_0100': ('outbox_events', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    'trg_state_transition_events_return_0100': ('state_transition_events', 'rsc_dispatch_stock_return_0100', 'A', 5, True, True, True),
    ...
    'trg_work_order_reversal_items_proof_0098': ('work_order_reversal_items', 'rsc_dispatch_work_order_reversal_0098', 'A', 5, True, True, True),
    'trg_work_order_reversal_items_immutable_0098': ('work_order_reversal_items', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_work_order_reversal_items_no_truncate_0098': ('work_order_reversal_items', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_removed_registration_create_0096': ('work_order_removed_serial_registrations', 'rsc_create_removed_identity_0096', 'A', 7, False, False, False),
    'trg_removed_registration_proof_0096': ('work_order_removed_serial_registrations', 'rsc_check_removed_registration_0096', 'A', 5, True, True, True),
    'trg_removed_registration_immutable_0096': ('work_order_removed_serial_registrations', 'rsc_guard_work_order_facts_0090', 'A', 27, False, False, False),
    'trg_removed_registration_no_truncate_0096': ('work_order_removed_serial_registrations', 'rsc_guard_work_order_facts_0090', 'A', 34, False, False, False),
    'trg_removed_serial_origin_0096': ('inventory_movement_serials', 'rsc_check_removed_origin_0096', 'A', 5, True, True, True),
    'trg_removed_registration_seal_0096': ('work_order_command_seals', 'rsc_check_removed_seal_0096', 'A', 5, True, True, True),
...
MATERIAL_REQUEST_APPROVAL_FUNCTION_BODY_SHA256 = {
    ...
    ('rsc_create_removed_identity_0096', ''): '5e844e093442b77d2ca8865bf897f2e8ee6022ec5eee34af13ba60c9391e8970',
    ('rsc_check_removed_registration_0096', ''): 'fa5dfc2e6e7dd28205494b249dc43abf613610a8ade91a9f65280ad4663a4e93',
    ('rsc_check_removed_origin_0096', ''): '6224c2ddd50bf29e7766f761949da8b58f709899e2d606cf6fe6e4fe50c393f1',
    ('rsc_check_removed_seal_0096', ''): '4d6c36ce9044f95a5a8f241f008b166f5cf5008fe1cb0f0191f57bab353c8d0c',
    ...
    ('rsc_check_serial_lifecycle_0092', 'uuid'): '334f3ca3d06af1d1dfe047b135d00859376c671c9f8140e9d56a2c56055415d9',
    ...
    ('rsc_check_work_order_material_transaction_0090', 'uuid'): 'fd501663654b0efc0abaa5378973083d61b1593303893144b956d70c8a99f994',
...
MATERIAL_REQUEST_APPROVAL_SECURITY_DEFINER_FUNCTIONS = frozenset(
    {
        ...
        ('rsc_dispatch_stock_return_outbound_0103', ''),
        ...
        ('rsc_create_removed_identity_0096', ''),
        ('rsc_check_removed_registration_0096', ''),
        ('rsc_check_removed_origin_0096', ''),
        ('rsc_check_removed_seal_0096', ''),
...
FORMAL_FILE_INTERNAL_FUNCTION_BODY_SHA256 = {
    ...
    ("rsc_require_opening_observation_account_0023", ""):
        "a948ebdb1db707c0d6656c2a485fbadb07f6ed3f372af0f1897a68e0c6a05089",
    ("rsc_opening_start_graph_complete_0052", "uuid, boolean"):
