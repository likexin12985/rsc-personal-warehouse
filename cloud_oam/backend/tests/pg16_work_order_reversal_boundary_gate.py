...
def assert_reversal_migration_rejects_detached_history(api_engine, fixture_engine):
    ...
    successors = [runpy.run_path(str(Path(__file__).parents[1] / "alembic/versions" / filename))
        for filename in ("20261012_0102_transit_opening_scopes.py", "20261011_0101_stock_return_request_seals.py", "20261010_0100_stock_return_orders.py", "20261009_0099_work_order_reversal_seals.py", "20261008_0098_work_order_reversals.py")]
    def catalog():
