...
def test_0052_opening_terminal_internal_function_manifest_is_exact() -> None:
    ...
    expected_hashes = {
        ...
        account_coordinate: runpy.run_path(str(Path(__file__).resolve().parents[1] / "alembic/versions/20261001_0091_work_order_account_admission.py"))["ACCOUNT_NEW_HASH"],
        reconciliation_effect_coordinate:
...
def test_0046_material_request_guard_catalog_accepts_exact_manifest(
    ...
    assert len(triggers) == 143
    assert len(functions) == 59
    _assert_material_request_approval_guards(
        triggers=triggers,
        functions=functions,
...
def test_0046_material_request_guard_trigger_query_captures_complete_scope(
    ...
    } == {"0029", "0030", "0045", "0046", "0059", "0060", "0069", "0070", "0071", "0072", "0077", "0087", "0090"}
...
def test_0045_material_request_approval_function_bodies_match_manifest(
    ...
    assert len(MATERIAL_REQUEST_APPROVAL_FUNCTION_BODY_SHA256) == 59
