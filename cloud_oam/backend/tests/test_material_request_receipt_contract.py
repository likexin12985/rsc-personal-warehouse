...
def test_receipt_input_is_strict():
    value = ReceiptIn(expected_request_version=2, receiver_person_id=ID, received_at="2026-09-09T10:00:00Z", lines=[{"shipment_line_id": ID, "accepted_qty": "1.000", "rejected_qty": "0.000", "condition": "normal"}])
