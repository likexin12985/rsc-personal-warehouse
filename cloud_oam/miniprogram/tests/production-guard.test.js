...
test('registered formal pages contain no v0.9 business request or deep link', () => {
  const source = [
    ...
    'pages/formal-personal-warehouse-transactions/index.wxml',
    'pages/formal-personal-warehouse-serials/index.js',
    'pages/formal-personal-warehouse-serials/index.wxml',
    ...
    'pages/formal-stock-return-outbounds/index.js',
    'pages/formal-stock-return-outbounds/index.wxml',
    'pages/formal-stock-return-shipments/index.js',
    'pages/formal-stock-return-shipments/index.wxml',
    'pages/formal-stock-return-receiving/index.js',
    'pages/formal-stock-return-receiving/index.wxml',
